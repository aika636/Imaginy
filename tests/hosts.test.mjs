...
// остаётся в силе (CLAUDE.md). Разметка каждого хоста собрана руками по его исходникам:
// живьём ни один хост здесь не запускается, см. docs/roadmap.md о границах проверки.
