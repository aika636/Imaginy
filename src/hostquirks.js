...
export function clearHostStyle() {
    try {
        ...
        if (host.quirks.styleOverride === 'slay') {
            ...
            // Единственная строка расширения, которая намеренно НЕ локализуется: это не
            // наш текст, а подпись в панели SLAY, и она обязана совпадать с тем, что
            // пишет туда сам SLAY. Перевод здесь означал бы, что в чужой панели после
            // нашего клика появилось слово, которого её собственный код не знает.
