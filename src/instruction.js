...
// Декодирование HTML-энтити в точности как делает хост при чтении атрибута: все пять
// замен независимы (не пересекаются по результату), порядок сохранён как в хосте.
...
// Порт decodeNumericEntities из хоста. ST энтити-кодирует
...
// кавычках, а decodeEntities не содержит правил &lt;/&gt; — если бы мы их
// экранировали, обратное decodeEntities не раскрутило бы их
